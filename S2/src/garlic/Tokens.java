...
public class Tokens implements Iterable<Token>, Iterator<Token> {
	...
	Tokens() {
		characters.add(new Token("Scarlett", Color.RED, new Coordinates(7,24), 
				new Coordinates(1,1), new Coordinates(10,6), new Coordinates(20,3), 
				new Coordinates(20,10), new Coordinates(18,15), new Coordinates(19,21), 
				new Coordinates(9,19), new Coordinates(2,19), new Coordinates(2,11)));
		characters.add(new Token("Mustard", Color.YELLOW, new Coordinates(0,17), 
				new Coordinates(2,1), new Coordinates(11,6), new Coordinates(21,3), 
		...
		characters.add(new Token("White", Color.WHITE, new Coordinates(9,0), 
				new Coordinates(3,1), new Coordinates(12,6), new Coordinates(22,3), 
		...
		characters.add(new Token("Green", Color.GREEN, new Coordinates(14,0), //green engineering?? weapon covering it
				new Coordinates(1,2), new Coordinates(10,7), new Coordinates(20,4), //obrien under weapon??
		...
		characters.add(new Token("Peacock", new Color(0, 191, 255), new Coordinates(23,6), //peacock ag?? under weapon?
				new Coordinates(2,2), new Coordinates(11,7), new Coordinates(21,4), //peacock comsci same as mustard!! changed
		...
		characters.add(new Token("Plum", new Color(148, 0, 211), new Coordinates(23,19), 
				new Coordinates(3,2), new Coordinates(12,7), new Coordinates(22,4), 
